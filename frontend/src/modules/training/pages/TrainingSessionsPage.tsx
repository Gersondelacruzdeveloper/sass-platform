  ...
  <div className="min-h-screen bg-slate-50">
    <div className="mx-auto max-w-7xl space-y-6 p-4 md:p-6 lg:p-8">
        ...
        <div className="flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
          <div>
            <div className="mb-3 inline-flex items-center gap-2 rounded-full bg-white/10 px-4 py-2 text-sm text-white/80">
              ...
              Centro de Programación de Entrenamientos
            </div>
      ...
      <section className="grid grid-cols-1 gap-4 sm:grid-cols-2 xl:grid-cols-5">
        <SummaryCard title="Total de Sesiones" value={sessions.length} icon={<ClipboardList />} />
        <SummaryCard title="Programadas" value={scheduled} icon={<Clock />} />
        <SummaryCard title="En Progreso" value={inProgress} icon={<PlayCircle />} />
        <SummaryCard title="Completadas" value={completed} icon={<CheckCircle2 />} />
        <SummaryCard title="Canceladas" value={cancelled} icon={<XCircle />} />
      </section>
      ...
      >
        ...
        <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
          <Input
            required
            label="Título"
            placeholder="Excelencia en Recuperación del Huésped"
            value={form.title}
