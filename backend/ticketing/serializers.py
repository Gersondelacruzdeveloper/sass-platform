...
class PublicProductPickupScheduleSerializer(serializers.ModelSerializer):
...
class PublicExperienceProductSerializer(ExperienceProductSerializer):
    ...
    pickup_schedules = serializers.SerializerMethodField()
    ...
    def get_pickup_schedules(self, obj):
        queryset = (
            obj.pickup_schedules
            .filter(
                is_active=True,
                pickup_location__is_active=True,
                pickup_location__organisation=obj.organisation,
            )
        ...
        return PublicProductPickupScheduleSerializer(
            queryset,
            many=True,
            context=self.context,
        ).data
